    ...
    <v-main class="mt-10">
      <v-layout row wrap class="mb-5">
        ...
        <v-flex xs12 md4 align-self-center offset-md2>
          <v-btn right color="#F26419" class="mr-2" dark rounded v-if="token==null">
      ...
      <v-tabs>
        ...
        <v-tab  v-if="type!=null">
          <router-link to="/sugerencias" class="lista">Panel de Control</router-link>
        </v-tab>
      </v-tabs>
      <router-view />
    </v-main>   
