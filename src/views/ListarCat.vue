                        ...
                        <template v-slot:default>
                            ...
                            <tbody>
                                <tr v-for="(categoria,index) of categoria" :key="index">
                                    ...
                                    <td>
                                        <v-btn color="light-blue" dark rounded 
      ...
      <v-card>
        ...
        <v-form ref="form" v-model="valid" class="ma-5">
          ...
          <v-btn
            ...
            color="success"
            class="mr-4"
            @click="validate; addCategoria(); add = false"
          >
            Aceptar</v-btn
          >
          <v-btn color="error" class="mr-4" @click="add = false"> Cerrar </v-btn>
...
<script>
    ...
    methods: {
        ...
        async getCategorias(){
            const _this=this
            const datos=await axios.get("http://localhost/proyecto/mycouncil/src/bbdd/crudCat.php?accion=leer").then(function(response){
        ...
        addCategoria(){
            ...
            axios.post("http://localhost/proyecto/mycouncil/src/bbdd/crudCat.php?accion=crear",formData).then(function(response){
        ...
        updateCategoria(){
            ...
            axios.post("http://localhost/proyecto/mycouncil/src/bbdd/crudCat.php?accion=editar",formData).then(function(response){
        ...
        deleteCategoria(){
            const _this = this
            var formData = _this.toFormData(_this.currentCategoria);
            axios.post("http://localhost/proyecto/mycouncil/src/bbdd/crudCat.php?accion=borrar",formData).then(function(response){
                _this.currentCategoria={};
                if(response.data.error){                   
                    _this.errorMsg=response.data.message;
                }else{
