...
<!--
  ...
  Vista en la que se hace el proceso de recuperacion de contraseña
 -->
    ...
    >
        <div id="formContent">
            ...
            <form v-on:submit.prevent="login">
                <input type="text" id="login" class="fadeIn second" name="login" placeholder="Correo" v-model="correo"><br>
                <label>¿Cual es el nombre de tu mascota?</label>
                <input label="" type="text" id="login" class="fadeIn second" name="login" placeholder="Pregunta Secreta" v-model="question">
