...
<!--
  ...
  Vista donde se hace el proceso de inicio de sesion del administrador solo accesible desde url /loginA
 -->
  <div
  ...
  >
    <div id="formContent">
      ...
      <form v-on:submit.prevent="login">
        ...
        />
        <v-btn class="light-blue" dark @click="login">Iniciar sesion</v-btn>
      </form>
      <!-- Remind Passowrd -->
      <div id="formFooter">
        <router-link class="underlineHover" to="/recoveryPass"
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      axios
        .post(
          "http://localhost/proyecto/mycouncil/src/bbdd/login.php?accion=inicioSesionA",
          data
        )
        .then((response) => {
