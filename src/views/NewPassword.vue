    ...
    >
        <div id="formContent">
            ...
            <form v-on:submit.prevent="login">              
                <input type="text" id="login" class="fadeIn second" name="login" placeholder="Nueva contraseña" v-model="question"><br>
                <input type="text" id="login" class="fadeIn second" name="login" placeholder="Repetir contraseña" v-model="question">
